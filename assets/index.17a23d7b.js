 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wr=NA;function PA(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:TT,automaticDataCollectionEnabled:!1},e),r=n.name;if(typeof r!="string"||!r)throw ki.create("bad-app-name",{appName:String(r)});const i=Pa.get(r);if(i){if(cc(t,i.options)&&cc(n,i.config))return i;throw ki.create("duplicate-app",{appName:r})}const s=new Vb(r);for(const a of lp.values())s.addComponent(a);const o=new AA(t,n,s);return Pa.set(r,o),o}function ig(t=TT){const e=Pa.get(t);if(!e)throw ki.create("no-app",{appName:t});return e}function OA(){return Array.from(Pa.values())}function xe(t,e,n){var r;let i=(r=RA[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ii.warn(a.join(" "));return}rn(new zt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cl{constructor(e,n){this.shortDelay=e,this.longDelay=n,er(n>e,"Short delay should be less than long delay!"),this.isMobile=uh()||ng()}get(){return GA()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ia(t){if(!!t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function rP(t,e=!1){const n=Ie(t),r=await n.getIdToken(e),i=lg(r);j(i&&i.exp&&i.auth_time&&i.iat,n.auth,"internal-error");const s=typeof i.firebase=="object"?i.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:i,token:r,authTime:ia(Ad(i.auth_time)),issuedAtTime:ia(Ad(i.iat)),expirationTime:ia(Ad(i.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function Ad(t){return Number(t)*1e3}function lg(t){var e;const[n,r,i]=t.split(".");if(n===void 0||r===void 0||i===void 0)return Nu("JWT malformed, contained fewer than 3 sections"),null;try{const s=rp(r);return s?JSON.parse(s):(Nu("Failed to decode base64 JWT payload"),null)}catch(s){return Nu("Caught error parsing JWT payload as JSON",(e=s)===null||e===void 0?void 0:e.toString()),null}}function iP(t){const e=lg(t);return j(e,"internal-error"),j(typeof e.exp<"u","internal-error"),j(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hl extends hg{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function OO(t=ig()){const e=co(t,"auth");return e.isInitialized()?e.getImmediate():WA(t,{popupRedirectResolver:xO,persistence:[$P,kP,KT]})}PO("Browser");const Z_="@firebase/database",e0="0.13.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class YO{constructor(e,n,r){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=r,this.auth_=null,this.auth_=r.getImmediate({optional:!0}),this.auth_||r.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(lt("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,r)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,r):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Vt(e)}}class fp{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}fp.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Od={},Dd={};function gg(t){const e=t.toString();return Od[e]||(Od[e]=new ZO),Od[e]}function eD(t,e){const n=t.toString();return Dd[n]||(Dd[n]=e()),Dd[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function PD(t,e){return ho(t.name,e.name)}function wg(t,e){return ho(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VD=!0;function ut(t,e=null){if(t===null)return U.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),N(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new je(n,ut(e))}if(!(t instanceof Array)&&VD){const n=[];let r=!1;if(Lt(t,(o,a)=>{if(o.substring(0,1)!=="."){const l=ut(a);l.isEmpty()||(r=r||!l.getPriority().isEmpty(),n.push(new W(o,l)))}}),n.length===0)return U.EMPTY_NODE;const s=yc(n,PD,o=>o.name,wg);if(r){const o=yc(n,Ce.getCompare());return new U(s,ut(e),new jn({".priority":o},{".priority":Ce}))}else return new U(s,ut(e),jn.Default)}else{let n=U.EMPTY_NODE;return Lt(t,(r,i)=>{if(ar(t,r)&&r.substring(0,1)!=="."){const s=ut(i);(s.isLeafNode()||!s.isEmpty())&&(n=n.updateImmediateChild(r,s))}}),n.updatePriority(ut(e))}}DD(ut);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jD extends mh{compare(e,n){const r=e.node.compareTo(n.node);return r===0?ho(e.name,n.name):r}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return W.MIN}maxPost(){return W.MAX}makePost(e,n){const r=ut(e);return new W(n,r)}toString(){return".value"}}const zD=new jD;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vM{getCompleteChild(e){return null}getChildAfterChild(e,n,r){return null}}const jS=new vM;class Rg{constructor(e,n,r=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=r}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const r=this.optCompleteServerCache_!=null?new Ai(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ng(this.writes_,e,r)}}getChildAfterChild(e,n,r){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Pi(this.viewCache_),s=gM(this.writes_,i,n,1,r,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hL{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function s1(t,e){let n=null;for(let r=0;r<e.length;r++){const i=e[r],s=i.getPath();n!==null&&!vg(s,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:s}),n.events.push(i)}n&&t.eventLists_.push(n)}function o1(t,e,n){s1(t,n),a1(t,r=>vg(r,e))}function zi(t,e,n){s1(t,n),a1(t,r=>dn(r,e)||dn(e,r))}function a1(t,e){t.recursionDepth_++;let n=!0;for(let r=0;r<t.eventLists_.length;r++){const i=t.eventLists_[r];if(i){const s=i.path;e(s)?(dL(t.eventLists_[r]),t.eventLists_[r]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function dL(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const r=n.getEventRunner();mi&&lt("event: "+n.toString()),ml(r)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fL="repo_interrupt",pL=25;class mL{constructor(e,n,r,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=r,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new hL,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=_c(),this.transactionQueueTree_=new Lg,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function gL(t,e,n){if(t.stats_=gg(t.repoInfo_),t.forceRestClient_||GO())t.server_=new vc(t.repoInfo_,(r,i,s,o)=>{b0(t,r,i,s,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>A0(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{qe(n)}catch(r){throw new Error("Invalid authOverride provided: "+r)}}t.persistentConnection_=new Kn(t.repoInfo_,e,(r,i,s,o)=>{b0(t,r,i,s,o)},r=>{A0(t,r)},r=>{vL(t,r)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(r=>{t.server_.refreshAuthToken(r)}),t.appCheckProvider_.addTokenChangeListener(r=>{t.server_.refreshAppCheckToken(r.token)}),t.statsReporter_=eD(t.repoInfo_,()=>new JD(t.stats_,t.server_)),t.infoData_=new KD,t.infoSyncTree_=new N0({startListening:(r,i,s,o)=>{let a=[];const l=t.infoData_.getNode(r._path);return l.isEmpty()||(a=vh(t.infoSyncTree_,r._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),$g(t,"connected",!1),t.serverSyncTree_=new N0({startListening:(r,i,s,o)=>(t.server_.listen(r,s,i,(a,l)=>{const u=o(a,l);zi(t.eventQueue_,r._path,u)}),[]),stopListening:(r,i)=>{t.server_.unlisten(r,i)}})}function yL(t){const n=t.infoData_.getNode(new le(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function l1(t){return JM({timestamp:yL(t)})}function b0(t,e,n,r,i){t.dataUpdateCount++;const s=new le(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(r){const l=uc(n,u=>ut(u));o=KM(t.serverSyncTree_,s,l,i)}else{const l=ut(n);o=qM(t.serverSyncTree_,s,l,i)}else if(r){const l=uc(n,u=>ut(u));o=zM(t.serverSyncTree_,s,l)}else{const l=ut(n);o=vh(t.serverSyncTree_,s,l)}let a=s;o.length>0&&(a=Vg(t,s)),zi(t.eventQueue_,a,o)}function A0(t,e){$g(t,"connected",e),e===!1&&wL(t)}function vL(t,e){Lt(e,(n,r)=>{$g(t,n,r)})}function $g(t,e,n){const r=new le("/.info/"+e),i=ut(n);t.infoData_.updateSnapshot(r,i);const s=vh(t.infoSyncTree_,r,i);zi(t.eventQueue_,r,s)}function _L(t){return t.nextWriteId_++}function wL(t){u1(t,"onDisconnectEvents");const e=l1(t),n=_c();gp(t.onDisconnect_,te(),(i,s)=>{const o=tL(i,s,t.serverSyncTree_,e);DS(n,i,o)});let r=[];gp(n,te(),(i,s)=>{r=r.concat(vh(t.serverSyncTree_,i,s));const o=IL(t,i);Vg(t,o)}),t.onDisconnect_=_c(),zi(t.eventQueue_,te(),r)}function EL(t,e,n){let r;K(e._path)===".info"?r=R0(t.infoSyncTree_,e,n):r=R0(t.serverSyncTree_,e,n),o1(t.eventQueue_,e._path,r)}function P0(t,e,n){let r;K(e._path)===".info"?r=Cp(t.infoSyncTree_,e,n):r=Cp(t.serverSyncTree_,e,n),o1(t.eventQueue_,e._path,r)}function CL(t){t.persistentConnection_&&t.persistentConnection_.interrupt(fL)}function u1(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),lt(n,...e)}function c1(t,e,n){return GS(t.serverSyncTree_,e,n)||U.EMPTY_NODE}function Ug(t,e=t.transactionQueueTree_){if(e||Eh(t,e),fo(e)){const n=d1(t,e);N(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&TL(t,vl(e),n)}else ZS(e)&&wh(e,n=>{Ug(t,n)})}function TL(t,e,n){const r=n.map(u=>u.currentWriteId),i=c1(t,e,r);let s=i;const o=i.hash();for(let u=0;u<n.length;u++){const c=n[u];N(c.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),c.status=1,c.retryCount++;const h=bt(e,c.path);s=s.updateChild(h,c.currentOutputSnapshotRaw)}const a=s.val(!0),l=e;t.server_.put(l.toString(),a,u=>{u1(t,"transaction put response",{path:l.toString(),status:u});let c=[];if(u==="ok"){const h=[];for(let d=0;d<n.length;d++)n[d].status=2,c=c.concat(ys(t.serverSyncTree_,n[d].currentWriteId)),n[d].onComplete&&h.push(()=>n[d].onComplete(null,!0,n[d].currentOutputSnapshotResolved)),n[d].unwatcher();Eh(t,Fg(t.transactionQueueTree_,e)),Ug(t,t.transactionQueueTree_),zi(t.eventQueue_,e,c);for(let d=0;d<h.length;d++)ml(h[d])}else{if(u==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{Vt("transaction at "+l.toString()+" failed: "+u);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=u}Vg(t,e)}},o)}function Vg(t,e){const n=h1(t,e),r=vl(n),i=d1(t,n);return SL(t,i,r),r}function SL(t,e,n){if(e.length===0)return;const r=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],u=bt(n,l.path);let c=!1,h;if(N(u!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)c=!0,h=l.abortReason,i=i.concat(ys(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=pL)c=!0,h="maxretry",i=i.concat(ys(t.serverSyncTree_,l.currentWriteId,!0));else{const d=c1(t,l.path,o);l.currentInputSnapshot=d;const f=e[a].update(d.val());if(f!==void 0){r1("transaction failed: Data returned ",f,l.path);let g=ut(f);typeof f=="object"&&f!=null&&ar(f,".priority")||(g=g.updatePriority(d.getPriority()));const E=l.currentWriteId,m=l1(t),p=nL(g,d,m);l.currentOutputSnapshotRaw=g,l.currentOutputSnapshotResolved=p,l.currentWriteId=_L(t),o.splice(o.indexOf(E),1),i=i.concat(jM(t.serverSyncTree_,l.path,p,l.currentWriteId,l.applyLocally)),i=i.concat(ys(t.serverSyncTree_,E,!0))}else c=!0,h="nodata",i=i.concat(ys(t.serverSyncTree_,l.currentWriteId,!0))}zi(t.eventQueue_,n,i),i=[],c&&(e[a].status=2,function(d){setTimeout(d,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?r.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):r.push(()=>e[a].onComplete(new Error(h),!1,null))))}Eh(t,t.transactionQueueTree_);for(let a=0;a<r.length;a++)ml(r[a]);Ug(t,t.transactionQueueTree_)}function h1(t,e){let n,r=t.transactionQueueTree_;for(n=K(e);n!==null&&fo(r)===void 0;)r=Fg(r,n),e=ue(e),n=K(e);return r}function d1(t,e){const n=[];return f1(t,e,n),n.sort((r,i)=>r.order-i.order),n}function f1(t,e,n){const r=fo(e);if(r)for(let i=0;i<r.length;i++)n.push(r[i]);wh(e,i=>{f1(t,i,n)})}function Eh(t,e){const n=fo(e);if(n){let r=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[r]=n[i],r++);n.length=r,JS(e,n.length>0?n:void 0)}wh(e,r=>{Eh(t,r)})}function IL(t,e){const n=vl(h1(t,e)),r=Fg(t.transactionQueueTree_,e);return iL(r,i=>{Ud(t,i)}),Ud(t,r),e1(r,i=>{Ud(t,i)}),n}function Ud(t,e){const n=fo(e);if(n){const r=[];let i=[],s=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(N(s===o-1,"All SENT items should be at beginning of queue."),s=o,n[o].status=3,n[o].abortReason="set"):(N(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(ys(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&r.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?JS(e,void 0):n.length=s+1,zi(t.eventQueue_,vl(e),i);for(let o=0;o<r.length;o++)ml(r[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mi=new ul("@firebase/firestore");function Y0(){return Mi.logLevel}function D(t,...e){if(Mi.logLevel<=Z.DEBUG){const n=e.map(py);Mi.debug(`Firestore (${yo}): ${t}`,...n)}}function nr(t,...e){if(Mi.logLevel<=Z.ERROR){const n=e.map(py);Mi.error(`Firestore (${yo}): ${t}`,...n)}}function X0(t,...e){if(Mi.logLevel<=Z.WARN){const n=e.map(py);Mi.warn(`Firestore (${yo}): ${t}`,...n)}}function py(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Al{constructor(e,n=null,r=[],i=[],s=null,o="F",a=null,l=null){this.path=e,this.collectionGroup=n,this.explicitOrderBy=r,this.filters=i,this.limit=s,this.limitType=o,this.startAt=a,this.endAt=l,this._t=null,this.wt=null,this.startAt,this.endAt}}function I$(t,e,n,r,i,s,o,a){return new Al(t,e,n,r,i,s,o,a)}function _y(t){return new Al(t)}function ow(t){return t.filters.length===0&&t.limit===null&&t.startAt==null&&t.endAt==null&&(t.explicitOrderBy.length===0||t.explicitOrderBy.length===1&&t.explicitOrderBy[0].field.isKeyField())}function CI(t){return t.explicitOrderBy.length>0?t.explicitOrderBy[0].field:null}function TI(t){for(const e of t.filters)if(e.dt())return e.field;return null}function k$(t){return t.collectionGroup!==null}function Ja(t){const e=H(t);if(e._t===null){e._t=[];const n=TI(e),r=CI(e);if(n!==null&&r===null)n.isKeyField()||e._t.push(new Ps(n)),e._t.push(new Ps(ct.keyField(),"asc"));else{let i=!1;for(const s of e.explicitOrderBy)e._t.push(s),s.field.isKeyField()&&(i=!0);if(!i){const s=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";e._t.push(new Ps(ct.keyField(),s))}}}return e._t}function rr(t){const e=H(t);if(!e.wt)if(e.limitType==="F")e.wt=rw(e.path,e.collectionGroup,Ja(e),e.filters,e.limit,e.startAt,e.endAt);else{const n=[];for(const s of Ja(e)){const o=s.dir==="desc"?"asc":"desc";n.push(new Ps(s.field,o))}const r=e.endAt?new Fc(e.endAt.position,e.endAt.inclusive):null,i=e.startAt?new Fc(e.startAt.position,e.startAt.inclusive):null;e.wt=rw(e.path,e.collectionGroup,n,e.filters,e.limit,r,i)}return e.wt}function $c(t,e,n){return new Al(t.path,t.collectionGroup,t.explicitOrderBy.slice(),t.filters.slice(),e,n,t.startAt,t.endAt)}function Pl(t,e){return vy(rr(t),rr(e))&&t.limitType===e.limitType}function SI(t){return`${yy(rr(t))}|lt:${t.limitType}`}function Bp(t){return`Query(target=${g$(rr(t))}; limitType=${t.limitType})`}function wy(t,e){return e.isFoundDocument()&&function(n,r){const i=r.key.path;return n.collectionGroup!==null?r.key.hasCollectionId(n.collectionGroup)&&n.path.isPrefixOf(i):L.isDocumentKey(n.path)?n.path.isEqual(i):n.path.isImmediateParentOf(i)}(t,e)&&function(n,r){for(const i of n.explicitOrderBy)if(!i.field.isKeyField()&&r.data.field(i.field)===null)return!1;return!0}(t,e)&&function(n,r){for(const i of n.filters)if(!i.matches(r))return!1;return!0}(t,e)&&function(n,r){return!(n.startAt&&!function(i,s,o){const a=iw(i,s,o);return i.inclusive?a<=0:a<0}(n.startAt,Ja(n),r)||n.endAt&&!function(i,s,o){const a=iw(i,s,o);return i.inclusive?a>=0:a>0}(n.endAt,Ja(n),r))}(t,e)}function N$(t){return t.collectionGroup||(t.path.length%2==1?t.path.lastSegment():t.path.get(t.path.length-2))}function II(t){return(e,n)=>{let r=!1;for(const i of Ja(t)){const s=R$(i,e,n);if(s!==0)return s;r=r||i.field.isKeyField()}return 0}}function R$(t,e,n){const r=t.field.isKeyField()?L.comparator(e.key,n.key):function(i,s,o){const a=s.data.field(i),l=o.data.field(i);return a!==null&&l!==null?Ys(a,l):z()}(t.field,e,n);switch(t.dir){case"asc":return r;case"desc":return-1*r;default:return z()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jh{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new M(C.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ct(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const XV=/^[cdef][\w-]{21}$/,Qp="";function JV(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=ZV(t);return XV.test(n)?n:Qp}catch{return Qp}}function ZV(t){return YV(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
